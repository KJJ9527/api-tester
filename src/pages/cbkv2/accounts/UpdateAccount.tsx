...
const paramDefinitions: ParamDefinition[] = [
  ...
  { name: 'legal_idnum', type: 'string', length: 18, required: '否', description: '法人证件号码' },
  ...
  { name: 'license_name', type: 'string', length: 100, required: '否', description: '证件名称' },
  { name: 'home_addr', type: 'string', length: 255, required: '否', description: '户籍地址,为身份证上的住址' },
...
const UpdateAccount: React.FC = () => {
  ...
  return (
    <ApiTester
      method="POST"
      path="v2/updateAccount"
      description="修改账户,仅支持中信通道的账户信息修改"
