...
const responseParamDefinitions: ParamDefinition[] = [
  ...
  { name: 'poundage', type: 'string', length: 11, required: '否', description: '提现手续费，单位分' },
  { name: 'trade_status', type: 'string', length: 2, required: '否', description: '订单状态 2：失败 3：处理中(具体到账时效以银行卡到账为准)' },
